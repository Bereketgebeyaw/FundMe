...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface MockV3AggregatorInterface extends Interface {
    getFunction(nameOrSignature: "decimals" | "getAnswer" | "getStartedAt" | "getTimestamp" | "latestAnswer" | "latestRound" | "latestRoundData" | "latestTimestamp" | "updateAnswer"): FunctionFragment;

    

    encodeFunctionData(functionFragment: 'decimals', values?: undefined): string;
encodeFunctionData(functionFragment: 'getAnswer', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'getStartedAt', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'getStartedAt', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'updateAnswer', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getStartedAt: TypedContractMethod<
      [arg0: BigNumberish, ],
      [bigint],
      'view'
    >
...
getFunction(nameOrSignature: 'getAnswer'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getStartedAt'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [bigint],
      'view'
    >;
